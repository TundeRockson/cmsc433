...
public class Simulation {
	...
	public static List<SimulationEvent> runSimulation(
		...
		custom.setMaxCapacity(numTables);



		// Start up machines
		Machines m = new Machines(null, null, machineCount);
...
// @formatter: on
		...
		Validate valid = new Validate(numCustomers, numCooks, numTables, machineCount);
